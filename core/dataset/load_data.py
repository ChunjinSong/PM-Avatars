...
def build_dataloader_scj(config):
    config = deepcopy(config)
    OmegaConf.set_struct(config, False)
    ...
    render_data_novel_pose = dataset.get_render_novel_pose_data()
    render_data_novel_view = dataset.get_render_novel_view_data()
    # render_data_training = dataset.get_render_training_data()
    ...
    return {
        ...
        'data_attrs': data_attrs,
        # 'render_data': render_data,
        'render_data_novel_pose': render_data_novel_pose,
        'render_data_novel_view': render_data_novel_view,
        # 'render_data_training': render_data_training,
    }
