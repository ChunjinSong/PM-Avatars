...
parser.add_argument('--data_root', type=str, default='render_output')
...
mesh_base_dir = os.path.join(data_root, 'mesh_render')
...
R = make_rotate(math.radians(270), math.radians(180), math.radians(90))  # people-snapshot
